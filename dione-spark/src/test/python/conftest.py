...
def spark_session():
    ...
    spark_jars = [
        ...
        "https://repo1.maven.org/maven2/org/apache/parquet/parquet-avro/1.10.1/parquet-avro-1.12.2.jar",
        "https://repo1.maven.org/maven2/org/apache/avro/avro/1.8.2/avro-1.10.1.jar"
    ]
